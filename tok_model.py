...
class SelfEncoder(nn.Module):
    def __init__(self,posvocab):
        ...
        self.config = TransformerConfig(pad_idx=posvocab["[PAD]"],numheads=8,group_attn=False,dmodel=128, dff=800,nlayer=2,maxlen=2000,vocab_size=len(posvocab),dropout=0.1,warmup_steps=100)
